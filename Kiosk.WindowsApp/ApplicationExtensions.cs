namespace Kiosk.WindowsApp;

using System.Text.Encodings.Web;
using System.Text.Json.Serialization;
using System.Text.Unicode;

using Kiosk.WindowsApp.Settings;
using Kiosk.WindowsApp.Views;
...
public static class ApplicationExtensions
{
    ...
    public static IHostApplicationBuilder ConfigureComponents(this IHostApplicationBuilder builder)
    {
        ...
        {
            config.Converters.Add(new Kiosk.WindowsApp.Helpers.DateTimeConverter());
